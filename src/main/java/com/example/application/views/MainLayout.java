...
import com.example.application.views.popularseries.PopularSeriesView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("Imersão Java - Alura");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Best 250 Movies", "la la-crown", Best250MoviesView.class), //

                new MenuItemInfo("Popular Movies", "la la-trophy", PopularMoviesView.class), //

                new MenuItemInfo("Best 250 Series", "la la-crown", Best250SeriesView.class), //

                new MenuItemInfo("Popular Series", "la la-trophy", PopularSeriesView.class), //
